...
- **Nota**: O projeto usa `xcode: latest` para sempre usar a versão mais recente disponível
- Para versões específicas, consulte: https://docs.codemagic.io/specs/versions-macos/
